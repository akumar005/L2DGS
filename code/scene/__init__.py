    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        if self.loaded_iter:
            self.gaussians.load_ply(os.path.join(self.model_path,
                                                           ...
                                                           "point_cloud.ply"), os.path.join(self.model_path,"point_cloud","iteration_" + str(self.loaded_iter),"light2rgb.pth"),\
            os.path.join(self.model_path,"point_cloud","iteration_" + str(self.loaded_iter),"noisenet.pth"))
